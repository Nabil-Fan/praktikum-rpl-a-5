...
<head>
    ...
    <title>Dashboard Merchant — EcoEats</title>
    ...
    <style>
        ...
        .badge { display: inline-block; background: rgba(185,148,112,0.12); color: #7a5c3a; padding: .3rem .8rem; border-radius: 999px; font-size: .75rem; font-weight: 700; letter-spacing: .08em; text-transform: uppercase; margin-bottom: 1rem; }
        form button { padding: .65rem 1.5rem; background: #B99470; color: white; border: none; border-radius: 10px; font-family: inherit; font-weight: 600; cursor: pointer; }
        form button:hover { background: #382C23; }
    </style>
</head>
<body>
    <div class="card">
        <span class="badge">🍽 Mitra Merchant</span>
        <h1>Dashboard Merchant</h1>
        <p>Selamat datang, {{ auth()->user()->name }}! Kelola makanan surplus Anda dari sini.</p>
