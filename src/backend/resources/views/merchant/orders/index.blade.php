...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sb-avatar { width: 36px; height: 36px; background: var(--camel); border-radius: 9px; display: flex; align-items: center; justify-content: center; font-size: .95rem; margin-bottom: .4rem; }
        .sb-name { font-size: .83rem; font-weight: 600; color: var(--cornsilk); }
        .sb-biz  { font-size: .7rem; color: var(--laurel); margin-top: .1rem; }
        ...
        .nav-item {
            ...
            font-size: .81rem; color: rgba(254,250,224,.55); text-decoration: none;
        ...
        .btn-logout {
            ...
            border: 1.5px solid rgba(254,250,224,.14); color: rgba(254,250,224,.45);
            border-radius: 8px; font-family: var(--font-b); font-size: .76rem; font-weight: 600;
...
<aside class="sidebar">
    ...
    <div class="sb-user">
        ...
        <div class="sb-biz">{{ $profile?->business_name ?? '—' }}</div>
    </div>
    <nav class="sb-nav">
